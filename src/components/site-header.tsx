...
export function SiteHeader() {
  ...
  return (
    <header className="flex min-h-(--header-height) shrink-0 items-center gap-2 border-b transition-[width,height] ease-linear group-has-data-[collapsible=icon]/sidebar-wrapper:min-h-(--header-height)">
      <div className="flex w-full items-center gap-1 px-4 py-5 lg:gap-2 lg:px-6">
        <SidebarTrigger className="-ml-1 self-center" />
        <Separator
          orientation="vertical"
          className="mx-2 self-center data-[orientation=vertical]:h-6"
        />
        <h1 className="text-xl font-semibold tracking-tight self-center">Dashboard</h1>
